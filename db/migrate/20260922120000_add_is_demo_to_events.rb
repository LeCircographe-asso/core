...
class AddIsDemoToEvents < ActiveRecord::Migration[8.1]
  def change
    ...
    # resteront marqués "démo" et garderont le badge public.
    add_column :events, :is_demo, :boolean, default: true, null: false
  end
end

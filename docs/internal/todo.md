...
*Audit continu : revu 2026-05-06 (12 commits), complété 2026-08-10 (audit doc), SESSION 2026-08-18 (sécurité: rate limiting, CSP nonce fix, Permissions-Policy, Brakeman/bundler-audit, 4 HIGH gems; autocomplete: API BAN, Stimulus controller, DRY form consolidation). Prochaine passe : Jetmail mailer + local env (Docker/Litestream), Turbo Streams audit.*

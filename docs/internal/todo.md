...
- [x] Garder des primitives assez stables pour accueillir plus tard GSAP 3 comme couche d’animation, sans devoir refaire la structure des pages. *(Infra : vendor `vendor/javascript/gsap`, `lib/gsap/register.js`, import dans `application.js` ; migration animation legacy hors scope immédiat — voir `docs/development/assets.md`.)*

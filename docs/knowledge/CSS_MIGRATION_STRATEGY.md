...
## 🧭 Next Focus
- **Component library** — terminer la migration des styles restants (legacy navbar résiduelle, overrides Swiper/Flowbite) et documenter les classes Tailwind custom.

...
- Bibliothèque de composants CSS structurée dans `app/assets/tailwind/components/` (boutons, formulaires, hero, badges, layout, dashboard, timeline, admin sidebar, animations, tooltips, Stripe).

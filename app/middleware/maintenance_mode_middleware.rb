...
ubuntu# screen
[detached from 4065371.pts-0.ubuntu]
ubuntu# screen -ls
There are screens on:
        4066416.rails   (09/30/25 16:02:20)     (Attached)
        4065371.pts-0.ubuntu    (09/30/25 15:59:30)     (Detached)
        1531179.rails   (04/24/25 03:14:19)     (Attached)
3 Sockets in /run/screen/S-root.
ubuntu# screen -X -S 4066416
Please specify a command.
ubuntu# screen -X -S 4066416 kill
ubuntu# screen ls
...
There are screens on:
        4066416.rails   (09/30/25 16:02:20)     (Attached)
        4065371.pts-0.ubuntu    (09/30/25 15:59:30)     (Detached)
        1531179.rails   (04/24/25 03:14:19)     (Detached)
3 Sockets in /run/screen/S-root.
ubuntu# screen -X -S 4066416 kill
ubuntu# screen -x rails
Fast-forward
 app/middleware/maintenance_mode_middleware.rb | 5 ++++-
 1 file changed, 4 insertions(+), 1 deletion(-)
root@ubuntu:/home/aka/Web-App/le_circographe# rails s
=> Booting Puma
...
*          PID: 4077892
* Listening on ssl://0.0.0.0:443?cert=.cert%2Fserver_cert_chain.crt&key=.cert%2F_.lecircographe.fr_private_key.key&verify_mode=none
Use Ctrl-C to stop
2025-09-30 16:58:21 +0000 SSL error, peer: 52.36.131.235, peer cert: : #<Puma::MiniSSL::SSLError: OpenSSL error: error:0A000102:SSL routines::unsupported protocol - 258>
2025-09-30 16:58:21 +0000 SSL error, peer: 52.36.131.235, peer cert: : #<Puma::MiniSSL::SSLError: OpenSSL error: error:0A00018C:SSL routines::version too low - 396>
2025-09-30 16:58:21 +0000 SSL error, peer: 52.36.131.235, peer cert: : #<Puma::MiniSSL::SSLError: OpenSSL error: error:0A000102:SSL routines::unsupported protocol - 258>
2025-09-30 16:58:21 +0000 SSL error, peer: 52.36.131.235, peer cert: : #<Puma::MiniSSL::SSLError: OpenSSL error: error:0A0000C1:SSL routines::no shared cipher - 193>
2025-09-30 16:58:21 +0000 SSL error, peer: 52.36.131.235, peer cert: : #<Puma::MiniSSL::SSLError: OpenSSL error: error:0A0000FC:SSL routines::unknown protocol - 252>
2025-09-30 17:11:12 +0000 SSL error, peer: 3.132.23.201, peer cert: : #<Puma::MiniSSL::SSLError: HTTP connection?>
Unsupported HTTP method used: PROPFIND
2025-09-30 17:14:46 +0000 SSL error, peer: 3.132.23.201, peer cert: : #<Puma::MiniSSL::SSLError: HTTP connection?>
2025-09-30 17:26:40 +0000 SSL error, peer: 165.232.129.254, peer cert: : #<Puma::MiniSSL::SSLError: HTTP connection?>
2025-09-30 17:42:51 +0000 SSL error, peer: 3.130.96.91, peer cert: : #<Puma::MiniSSL::SSLError: HTTP connection?>
2025-09-30 17:42:52 +0000 SSL error, peer: 3.130.96.91, peer cert: : #<Puma::MiniSSL::SSLError: HTTP connection?>
Unsupported HTTP method used: PROPFIND
2025-09-30 17:47:29 +0000 SSL error, peer: 3.130.96.91, peer cert: : #<Puma::MiniSSL::SSLError: HTTP connection?>
2025-09-30 18:00:40 +0000 SSL error, peer: 185.247.137.15, peer cert: : #<Puma::MiniSSL::SSLError: OpenSSL error: error:0A000102:SSL routines::unsupported protocol - 258>
2025-09-30 18:02:19 +0000 SSL error, peer: 185.247.137.20, peer cert: : #<Puma::MiniSSL::SSLError: OpenSSL error: error:0A0000C1:SSL routines::no shared cipher - 193>
2025-09-30 18:02:52 +0000 SSL error, peer: 87.236.176.37, peer cert: : #<Puma::MiniSSL::SSLError: OpenSSL error: error:0A00006C:SSL routines::bad key share - 108>

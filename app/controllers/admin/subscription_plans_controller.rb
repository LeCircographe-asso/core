module Admin
  class SubscriptionPlansController < BaseController
    before_action :set_contribution_formula, only: [ :show, :edit, :update, :destroy ]
    ...
    def create
      ...
      custom_amount = if contribution_purchase_params[:payment_method] == "offered"
                        contribution_purchase_params[:custom_amount_cents]&.to_i || 0
      end

module Admin
  class MembersController < BaseController
    ...
    def membership_recap
      # session[:membership_data] = params.permit(:cirque, :tarif, :graff, :soutien, :prenom, :nom, :date_naissance, :adresse, :code_postal, :ville, :pays, :telephone, :email, :profession, :specialite, :droit_image, :newsletter_subscribed, :investir, :soutenir_financierement).to_h

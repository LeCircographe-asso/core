...
RSpec.describe ContributionFormula, type: :model do
  ...
  describe 'associations' do
    ...
    it "destroys contributions when deleted" do
      person = create(:person)
      entry = create(:contribution, person: person, contribution_formula: plan)
  ...
  describe 'instance methods' do
    ...
    describe '#price_change_percentage' do
      ...
      it "calculates percentage correctly for price decrease" do
        lower_plan = create(:contribution_formula, membership_type: circus_membership_type, name: "Test Plan", version: 3, effective_from: Date.current + 1.day, price_cents: 3000)
      ...
      context 'edge cases' do
        ...
        it "rounds result to 2 decimal places" do
          ...
          other_plan = create(:contribution_formula, membership_type: circus_membership_type, name: "Odd Plan", version: 2, effective_from: Date.current, price_cents: 5000)
    ...
    describe '.create_default_plans!' do
      ...
      context 'when no plans exist' do
        it "creates all default plans for circus_full" do
          ...
          }.to change(ContributionFormula, :count).by(8) # 4 plans × 2 circus types
        end
      ...
      context 'when plans already exist' do
        ...
        it "does not duplicate existing plans" do
          expect {
            ContributionFormula.create_default_plans!
          }.not_to change(ContributionFormula, :count)
        end

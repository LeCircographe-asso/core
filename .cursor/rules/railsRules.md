...
Mon application est en rails 8.1 et utilise une base de données SQLITE3
Respecte les conventions de nommages, DRY et séparattion de logique. 
L'utilisation de turbo stream / turbo frame et les outils natifs de rails 8.1 sont à prendre en considération.
Séparé la logique métier.
Toujours réduire les controller au plus petit, moins de ligne possible. Utiliser les model pour fournir de la logique métier.

Réfère toi un maximum à la logique métier de mon application de gestion d'association, mix de "CRM" et "CMS" avec un site vitrine.

Si tu fabrique des nouveaux fichiers ou composants fait toujours en sorte de les utiliser ou de les supprimer si inutilisé.

L'espace utilisateurs est utilisé par toute personnes voulant s'isncrire sur le site. Le dashboard admin est utilisable par les "Bénévole/volunteer", "admin" et "superAdmin"

Le code doit toujours être en anglais
Quand on écrit un commit c'est en anglais

Répond moi en français ou anglais et explique moi ce que l'on fait

Always answer me by saying "Quack I'm your slave"



# Rails 8.1 Development Guidelines

## 1. Rails 8.1 Core Features
...
2. **Database Best Practices**
   ...
   - Use Sqlite3 for development, test, and production environments
...
3. **Testing**
   ...
   - Write comprehensive Minitest/rspec tests
...
- **Testing**: Rspec, Capybara, fixtures
...
- **Authorization**: built in level of authorization using rails principles
